---
title: Wombat Division
description: Directorate records for active wombat specimens, containment incidents, and related archive material.
published: true
date: 2026-06-06T22:51:46.314Z
tags: wombats, containment, directorate
editor: markdown
...
padding:22px;
margin:0 0 24px 0;
box-shadow:0 0 22px rgba(126,232,90,.22);
">

<div style="display:flex;align-items:center;gap:22px;flex-wrap:wrap;">

<img
src="/images/wombats/wombat_nav_logo_1780686441137.png"
alt="Wombat Containment Division"
style="
width:220px;
max-width:100%;
border:2px solid #7ee85a;
box-shadow:0 0 16px rgba(126,232,90,.28);
background:#050805;
"
>
...
color:#8cff5a;
letter-spacing:.08em;
text-shadow:0 0 12px rgba(140,255,90,.35);
">
☢️ WOMBAT CONTAINMENT DIVISION
</h1>

<p style="font-size:17px;margin:8px 0 16px 0;">
Directorate archive for active wombat specimens, containment failures,
field observations, and incident reports.
</p>
...
margin-top:14px;
">
<div style="border:1px solid rgba(126,232,90,.35);padding:10px;background:#151d17;"><strong>Directorate Status</strong><br>CONCERNED</div>
<div style="border:1px solid rgba(126,232,90,.35);padding:10px;background:#151d17;"><strong>Active Specimens</strong><br>13</div>
<div style="border:1px solid rgba(126,232,90,.35);padding:10px;background:#151d17;"><strong>Containment Integrity</strong><br>DECLINING</div>
</div>
...
- [Chief Scientist](/pages/stankopedia/wombats/chief-scientist)
- [Flower Incident](/pages/stankopedia/wombats/flower-incident)
- [Journal Archive](/pages/stankopedia/wombats/journal-archive/index)
- [Legacy Wombat Division Record](/pages/stankopedia/wombats/wombat-division)

> **Containment Notice:** Wombat Division records are not to be corrected, normalized, deodorized, or made reasonable without written Directorate approval.

...
Funkodynamics explores the measurable, theoretical, and deeply suspicious properties of funk under laboratory-adjacent conditions.
...
The earliest known references to funkodynamics appear in partially damp notes recovered from the Archive of Grimehold. The notes were later cross-filed by the Ministry of Mild Confusion, misplaced by the Office of Questionable Science, and rediscovered inside a box labeled "probably cables."
...
1. Journal of Applied Must Studies, Vol. 5, Issue 1.
2. Annals of Suspicious Freshness, Vol. 44, Issue 2.
3. Proceedings of the Third Funk Congress, Vol. 1, Issue 1.
4. Basement Studies Quarterly, Vol. 37, Issue 6.
